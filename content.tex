...
\subsubsection{Ovládanie pomocou reči} % (fold)
...
\subsubsection{Ovládanie pomocou gyroskopu} % (fold)
...
\subsubsection{Ovládanie pomocou webkamery} % (fold)
...
\subsubsection{Modul youtube videa} % (fold)
...
% \newpage
\subsubsection{Modul google maps} % (fold)
